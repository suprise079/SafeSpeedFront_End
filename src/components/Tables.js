...
export const TransactionsTable = () => {
  ...
  const TableRow = (props) => {
    ...
    const statusVariant =
      status === "Paid" ? "success" : status === "Due" ? "warning" : status === "Canceled" ? "danger" : "primary";
      ...
      <tr>
        ...
        <td>
          <Dropdown as={ButtonGroup}>
            ...
            <Dropdown.Menu>
              <Dropdown.Item>
                <FontAwesomeIcon icon={faEye} className="me-2" /> Run
              </Dropdown.Item>
              <Dropdown.Item>
    ...
    <Card border="light" className="table-wrapper table-responsive shadow-sm">
      <Card.Body className="pt-0">
        <Table hover className="user-table align-items-center">
          <thead>
            <tr>
              <th className="border-bottom">Sampler</th>
              <th className="border-bottom">Type</th>
              <th className="border-bottom">Last Modified</th>
              <th className="border-bottom">BaseUrl</th>
