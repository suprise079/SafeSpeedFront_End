...
export const AddSamplerForm = () => {
  const [birthday, setBirthday] = useState("");

  return (
    <Card>
      <Card.Body>
        <h5 className="mb-4">Add Sampler</h5>
        <Form>
          ...
          <Row>
            <Col md={8} className="mb-3">
              <Form.Group>
                <Form.Label>Sampler Type</Form.Label>
                <Form.Select>
                  <option defaultValue>HTTP/HTTPS Request</option>
                  <option>FTP Request</option>
                  <option disabled>JDBC Request</option>
                  <option disabled>BSF Sampler</option>
                </Form.Select>
              </Form.Group>
            </Col>
...
export const ThreadForm = () => {
  ...
  return (
    <Card border="light" className="bg-white shadow-sm mb-4">
      <Card.Body>
        <h5 className="mb-4">Configure Thread</h5>
        <Form>
          <Row>
            <Col md={6} className="mb-3">
              <Form.Group id="firstName">
